...
class Auth extends CI_Controller
{
	...
	private function _sendEmail($token, $type)
	{
		$config = [
			...
			'smtp_user' => 'cobacoba250800@gmail.com',
			'smtp_pass' => 'khusnul250800',
			'smtp_port' => 465,
			'mailtype' => 'html',
			'charset' => 'utf-8',
			'newline' => "\r\n"
		...
		$this->email->from('cobacoba250800@gmail.com', 'Ipin');
