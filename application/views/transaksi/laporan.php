...
<head>
  ...
  <title>Dashboard Laporan Posisi Kas</title>
...
$pengeluaran_hari_ini = mysqli_query($koneksi, "SELECT SUM(nominal) as total FROM pengeluaran WHERE tgltrans = CURDATE() AND kdumkm = '$kdumkm'");
$pengeluaran_hari_ini = mysqli_fetch_array($pengeluaran_hari_ini);
$total_pengeluaran_hari_ini = $pengeluaran_hari_ini['total'];

$pemasukan_hari_ini = mysqli_query($koneksi, "SELECT SUM(nominal) as total FROM pemasukan WHERE tgltrans = CURDATE() AND kdumkm = '$kdumkm'");
$pemasukan_hari_ini = mysqli_fetch_array($pemasukan_hari_ini);
$total_pemasukan_hari_ini = $pemasukan_hari_ini['total'];
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">LAPORAN POSISI KAS</h1>
          ...
          <div class="row">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
				...
				<?php
				//echo number_format($nominalmasuk,2,',','.');
        echo number_format($nominalmasuk);
				?>
			</div>
            </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-danger shadow h-100 py-2">
				...
				<?php
				echo number_format($nominalkeluar,2,',','.');
				?>
              </div>
            </div>
...
var ctx = document.getElementById("myPieChart");
  var myPieChart = new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [{
        data: [<?php echo $nominalmasuk/1000000 ?>, <?php echo $nominalkeluar/1000000 ?>, <?php echo $uang/1000000 ?>],
